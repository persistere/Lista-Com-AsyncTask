package com.example.satoruchannel.listacomasynctask;
...
import com.example.satoruchannel.listacomasynctask.adapter.AndroidAdapter;
...
public class ListaActivity extends AppCompatActivity {
    ...
    //Params: Tipo do Objeto que será passado por parâmetro, caso
    // não precise mandar algum parâmetro, colocar colo "Void";
    //Progress: Tipo do Objeto usado para informar o progresso do
    // processo, utilizados no método publishProgress(Progress...) e onProgressUpdate(Progress...);
    //Result: Tipo do Objeto de Retorno. Usado no método onInBackground(Params...)
    // como sendo o seu retorno e o onPostExecute(Result).
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pdLoading.setCancelable(false); // O usuário não pode cancelar o Loading
            pdLoading.show();
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                JSONArray jArray =
                        json.getJSONArray(Android.TAG_ANDROID);
                ...
                Toast.makeText (ListaActivity.this , e.toString(),
                        Toast.LENGTH_LONG).show();
            }
        }
    }
    private void setUpRecyclerView(List<Android> data) {
        RecyclerView rcLista = findViewById(R.id.rvLista);
